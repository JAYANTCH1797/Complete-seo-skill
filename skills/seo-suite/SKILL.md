...
| "what is my audience discussing", "mine reddit/youtube", "audience research", "secondary research", "topic mining", "scrape social" | `../../references/social-topic-mining.md` | Scrape Reddit/YouTube/Instagram → extract hierarchical topics (L0→L2) → seed keywords. Harvest adapters in `../../references/content-scraping.md` |
...
Phase 1 starts with seed research — Claude offers four paths: online research (Reddit/web) — formalized in `../../references/social-topic-mining.md`, with harvest adapters in `../../references/content-scraping.md` — user-provided insights (sales calls, support, ORM), competitor gap analysis (defers to `../../references/content-gap.md`), or specific topic expansion. Paths can be combined. Claude presents findings and waits before moving to Semrush validation.
